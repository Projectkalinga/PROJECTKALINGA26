...
export function ArchitectureFlow() {
    ...
    return (
        <div className="w-full space-y-8" ref={containerRef}>
            ...
            {/* Phase Stepper */}
            <div className="flex flex-wrap justify-center gap-2 md:gap-4 p-4 glass-panel rounded-xl border border-white/10 relative z-20">
            ...
            <div className="relative w-full h-[600px] md:h-[700px] bg-[#050505] rounded-2xl border border-white/10 overflow-hidden shadow-2xl">
                ...
                <svg className="absolute inset-0 w-full h-full pointer-events-none z-0">
                    <defs>
                        <marker id="arrow" markerWidth="8" markerHeight="8" refX="8" refY="4" orient="auto">
                            <path d="M0,0 L0,8 L8,4 z" fill="#4a5568" />
                        </marker>
                        <marker id="arrow-active" markerWidth="8" markerHeight="8" refX="8" refY="4" orient="auto">
                            <path d="M0,0 L0,8 L8,4 z" fill="#FF4500" />
                        </marker>
                    </defs>

                    {/* --- SVG PATHS --- */}
                    {/* Cluster 1 (Base) -> Cluster 3 (FCU) */}
                    <path id="path-base-fcu" className="flow-path" d="M150,350 C250,350 300,350 400,350" stroke="#FF4500" strokeWidth="2" fill="none" />
